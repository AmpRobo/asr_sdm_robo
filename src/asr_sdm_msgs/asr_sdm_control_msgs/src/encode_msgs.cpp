#include "asr_sdm_control_msgs/encode_msgs.h"
#include <asr_sdm_control_msgs/comm_types.h>
#include <cstring>
                      ...
                      std::vector<uint8_t> & output)
{
  ...
  so3_cmd_input.seq = static_cast<uint8_t>((so3_command.header.stamp.sec) % 255);
                    ...
                    std::vector<uint8_t> & output)
{
  ...
  ppr_gains.Kp = gains.k_p;
  ppr_gains.Kd = gains.k_d;
  ppr_gains.Kp_yaw = gains.k_p_yaw;
  ppr_gains.Kd_yaw = gains.k_d_yaw;
