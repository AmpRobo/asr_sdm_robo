...
int main(int argc, char** argv)
{
  ...
  node = rclcpp::Node::make_shared("multi_map_visualization");
  ...
  pub1 = node->create_publisher<multi_map_server::msg::MultiOccupancyGrid>("maps2d", latched);
  pub2 = node->create_publisher<sensor_msgs::msg::PointCloud>("map3d", latched);
