...
Logging simulation stack: map generation, dynamics simulation, RViz, plus optional robot model, kinematic control, gamepad teleop, and planning.
...
colcon build --packages-up-to logging_simulator
...
| `/simulator/logging_simulator/add_static_obstacle` | Click-to-add pillar obstacles (RViz Static Obstacle tool) |
...
|---|---|
| `logging_simulator` | Simulation, map, RViz, top-level assemble |
...
| `/simulator/logging_simulator/add_static_obstacle` | RViz Static Obstacle 工具点击加点柱障碍 |
...
| 包 / launch | 负责 |
|---|---|
| `logging_simulator` | 仿真、地图、RViz、一键拼装 |
