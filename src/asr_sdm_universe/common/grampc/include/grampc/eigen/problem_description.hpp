 ...
 *
 */
#ifndef GRAMPC_EIGEN_PROBLEM_DESCRIPTION_HPP
#define GRAMPC_EIGEN_PROBLEM_DESCRIPTION_HPP

extern "C"
{
    #include <grampc/grampc.h>
}

#include <grampc/eigen/types.hpp>
#include <memory>
...
namespace grampc
{
    class ProblemDescription
    {
        ...
        public:
            ProblemDescription(ctypeInt Nx, ctypeInt Nu, ctypeInt Np, ctypeInt Ng, ctypeInt Nh, ctypeInt NgT, ctypeInt NhT) 
