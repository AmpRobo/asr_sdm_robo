...
#ifndef TEMPLATE_PROBLEM_DESCRIPTION_HPP
#define TEMPLATE_PROBLEM_DESCRIPTION_HPP
...
{
public:
    TemplateProblemDescription(const std::vector<typeRNum>& pSys, const std::vector<typeRNum>& pCost, const std::vector<typeRNum>& pCon);
...
#endif // TEMPLATE_PROBLEM_DESCRIPTION_HPP